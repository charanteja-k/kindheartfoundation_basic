    ...
    if (mainNav && navContainer) {
        window.addEventListener("scroll", () => {
            if (window.scrollY > 50) {
                mainNav.classList.remove("w-full", "top-0", "border-b");
                mainNav.classList.add("w-[95%]", "max-w-5xl", "top-4", "rounded-full", "border", "shadow-md");
                navContainer.classList.remove("h-20");
                navContainer.classList.add("h-16");
            } else {
                mainNav.classList.add("w-full", "top-0", "border-b");
                mainNav.classList.remove("w-[95%]", "max-w-5xl", "top-4", "rounded-full", "border", "shadow-md");
